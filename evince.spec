...
Source0  : https://download.gnome.org/sources/evince/41/evince-41.3.tar.xz
...
%prep
%setup -q -n evince-41.3
cd %{_builddir}/evince-41.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637606606
...
cp %{_builddir}/evince-41.3/COPYING %{buildroot}/usr/share/package-licenses/evince/e3afbcad74dd08819b5de5ad0338203369731f67
cp %{_builddir}/evince-41.3/cut-n-paste/synctex/LICENSE %{buildroot}/usr/share/package-licenses/evince/024379152453bda1d28e9126d8685fa222c1174d
cp %{_builddir}/evince-41.3/cut-n-paste/unarr/COPYING %{buildroot}/usr/share/package-licenses/evince/f45ee1c765646813b442ca58de72e20a64a7ddba
cp %{_builddir}/evince-41.3/help/C/license.page %{buildroot}/usr/share/package-licenses/evince/99449fd3e6417f1f32dbe2a5b252880badb25704
